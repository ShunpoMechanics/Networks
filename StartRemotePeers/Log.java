...
public class Log {
	...
	*/
	...
	public static void TCPto(int peer1, int peer2) {
	    String message = " makes a connection to Peer " + peer2 + ".";
	    writeLog(peer1, message);
	}

	public static void TCPfrom(int peer1, int peer2) {
	    String message = " is connected from Peer " + peer2 + ".";
	    writeLog(peer1, message);
	}

	// Preferred Neighbors
	public static void preferredNeighbors(int peer1, int [] neighbors) {
		String message = " has the preferred neighbors ";
